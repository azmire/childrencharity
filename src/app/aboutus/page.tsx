        ...
        <div className="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              children&apos;s crisis. We saw the statistics, the headlines, but
              more importantly, the real children facing unimaginable hardships.
              We built this platform to empower individuals to make a real
              difference.
              <div className="font-bold">
              ...
              connecting you with impactful children&apos;s charities. Every
              line of code reflects our goal: empower you to be the change.
              <div className="font-bold">
                More Than Donations, a Supportive Community
              </div>
              Stand With Children goes beyond secure donations. Here&apos;s what
              you can experience: Find Your Cause: Search a comprehensive
              database of verified charities aligned with your passions. Donate
              with Confidence: Every contribution is processed through secure
              ...
              <div className="font-bold">Join the Movement</div> We&apos;re a
              small team with a big dream. If you share our vision of a brighter
              future for children, let&apos;s connect! Email:
              angelo.zmire@gmail.com | ezzbendev@gmail.com
              <div className="font-bold">
                Together, We Can Make a Difference
              </div>
              Stand With Children is a testament to the power of passion and a
              desire to help. By joining us, you&apos;re not just supporting
              children in need, you&apos;re inspiring a new generation of
              developers who believe technology can change the world.
